package org.as3openni.flash.nite.sockets
{
	...
	import org.as3openni.flash.nite.events.NiteCircleEvent;
	import org.as3openni.flash.nite.events.NiteGestureEvent;
	import org.as3openni.flash.nite.events.NiteSessionEvent;
	import org.as3openni.flash.nite.events.NiteSliderEvent;
	import org.as3openni.flash.nite.events.NiteTrackPadEvent;
	import org.as3openni.flash.util.FLBasicSocket;
	
	public class FLNiteSessionSocket extends FLBasicSocket
	{
		public static const NITE_SESSION_SOCKET:String = "nite_session_socket";
		
		public function FLNiteSessionSocket()
		{
			super();
