package org.as3openni.flash.openni.sockets
{
	...
	import org.as3openni.flash.objects.NiSkeleton;
	import org.as3openni.flash.openni.events.ONISkeletonEvent;
	import org.as3openni.flash.openni.events.ONIUserTrackingEvent;
	import org.as3openni.flash.util.FLBasicSocket;
	
	public class FLONIUserTrackingSocket extends FLBasicSocket
	{
		public static const OPEN_NI_USER_TRACKING_SOCKET:String = "open_ni_user_tracking_socket";
		
		public function FLONIUserTrackingSocket()
		{
			super();
